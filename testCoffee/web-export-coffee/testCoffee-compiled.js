var SketchTestcoffee;

SketchTestcoffee = (function() {
  ...
  SketchTestcoffee.name = 'SketchTestcoffee';

  function SketchTestcoffee() {}

  blockSize = 10;

  SketchTestcoffee.prototype.setup = function() {
    ...
    var x, y,
      _this = this;
    size(500, 500);
    this.nullIterate = function(x, y) {
      var living;
      living = _this.nearbyOfType(x, y, _this.golIterate);
      if (living === 2) {
        return _this.golIterate;
      }
      return _this.nullIterate;
    };
    this.golIterate = function(x, y) {
      var living;
      living = _this.nearbyOfType(x, y, _this.golIterate);
    ...
    this.nullIterate.color = color(255);
    this.golIterate.color = color(0);
    this.cells = (function() {
      var _i, _ref, _results;
      _results = [];
      for (y = _i = 0, _ref = height / blockSize; 0 <= _ref ? _i < _ref : _i > _ref; y = 0 <= _ref ? ++_i : --_i) {
        _results.push((function() {
          var _j, _ref1, _results1;
          _results1 = [];
          for (x = _j = 0, _ref1 = width / blockSize; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; x = 0 <= _ref1 ? ++_j : --_j) {
            _results1.push(this.init(x, y));
          }
          return _results1;
        }).call(this));
      }
  ...
  SketchTestcoffee.prototype.draw = function() {
    var entry, next, x, y, _i, _j, _ref, _ref1;
    ...
    if (mousePressed === true) {
      ...
      for (x = _i = 0, _ref = this.cells.length; 0 <= _ref ? _i < _ref : _i > _ref; x = 0 <= _ref ? ++_i : --_i) {
        for (y = _j = 0, _ref1 = this.cells[x].length; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; y = 0 <= _ref1 ? ++_j : --_j) {
          entry = this.cells[x][y];
          fill(entry.color);
  ...
  SketchTestcoffee.prototype.getAt = function(x, y) {
    x = (x + this.cells.length) % this.cells.length;
    y = (y + this.cells[0].length) % this.cells[0].length;
    return this.cells[x][y];
  };

  SketchTestcoffee.prototype.nearby = function(x, y) {
    var i, j;
  ...
  SketchTestcoffee.prototype.nearbyOfType = function(x, y, type) {
    var _this = this;
    return this.nearby(x, y).filter(function(f) {
      return f === type;
    }).length;
  };

  SketchTestcoffee.prototype.init = function(x, y) {
    if (random() < .5) {
      return this.nullIterate;
    } else {
      return this.golIterate;
    }
  };

  return SketchTestcoffee;
